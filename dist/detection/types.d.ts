...
export type ElementCategory = 'button' | 'link' | 'text-input' | 'select' | 'textarea' | 'checkbox' | 'radio' | 'slider' | 'tab' | 'menu' | 'menu-item' | 'modal' | 'accordion' | 'carousel' | 'toggle' | 'dialog-trigger' | 'navigation' | 'search' | 'custom-component' | 'focusable-other';
...
export type NavigationPattern = 'header-nav' | 'sidebar-nav' | 'footer-nav' | 'breadcrumb' | 'pagination' | 'tab-group' | 'accordion-group' | 'dropdown-menu';
